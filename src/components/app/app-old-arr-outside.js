...
const App = () => {
    ...
    const onActionClick = (act) => {
        ...
        switch (true) {
            ...
            case act === '+/-':
                ...
                // double minus
                if (value[idSpase - 1] === '-') {
                    value = [...value.slice(0, idSpase + 1), '(', neg, ')'];
                } else {
                    value = [...value.slice(0, idSpase + 1), neg];
                }
                break;
            ...
            case act === 'sqrt':
                ...
                value = [...value.slice(0, idSpase + 1), sqrt];
                break;

            default: value = [...value, ' ', act, ' '];
        }
    ...
    const onResultClick = () => {
        ...
        const a = eval(number.replace(/\s/g, '')); // delete space
        value = [a];
        setNumber(value.join(''));
    };
